// fountain-js 0.1.10 (modified for CJK support)
// http://www.opensource.org/licenses/mit-license.php
// Copyright (c) 2012 Matt Daly
// Modified: dialogue regex supports Chinese characters (CJK)
...
; (function () {
    ...
    var regex = {
        ...
        // MODIFIED: added \u4e00-\u9fff (CJK) and \p{L} support for Chinese character names
        dialogue: /^([\u4e00-\u9fffA-Z*_]+[0-9\u4e00-\u9fffA-Z (._\-')]*)(\^?)?(?:\n(?!\n+))([\s\S]+)/,
        parenthetical: /^(\(.+\))$/,
